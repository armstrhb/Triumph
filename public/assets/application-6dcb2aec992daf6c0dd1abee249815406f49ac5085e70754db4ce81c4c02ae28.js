...
(function() {
  $.rails.allowAction = function(element) {
    ...
    $link = element.clone().removeAttr('class').removeAttr('data-confirm').addClass('btn').addClass('btn-danger').html("Don't question me! DO IT.");
    modal_html = "<div class=\"modal fade\" id=\"myModal\" aria-labelledby=\"myModalLabel\" role=\"dialog\" aria-hidden=\"true\">\n  <div class=\"modal-dialog\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <a class=\"close\" data-dismiss=\"modal\">×</a>\n        <h3>" + message + "</h3>\n      </div>\n      <div class=\"modal-body\">\n        <p>This is <strong>permanent</strong>.</p>\n      </div>\n      <div class=\"modal-footer\">\n        <a data-dismiss=\"modal\" class=\"btn\">Cancel</a>\n      </div>\n    </div>\n  </div>\n</div>";
